  ...
  return (
    <div className="prose prose-slate prose-invert max-w-none 
      ...
      prose-a:text-blue-400 hover:prose-a:text-blue-300
        prose-img:rounded-xl prose-img:shadow-2xl prose-img:border prose-img:border-white/10 prose-img:max-w-full prose-img:h-auto prose-img:max-h-[500px] prose-img:object-contain prose-img:my-4 prose-img:mx-auto
