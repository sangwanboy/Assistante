            ...
            <div className="px-5 py-3 border-b border-[#1a1a2e] flex items-center justify-between bg-[#0a0a14]">
              ...
              <div className="flex flex-wrap items-center justify-end gap-3 flex-shrink-0">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold bg-indigo-500/10 border border-indigo-500/20 text-indigo-400 rounded-lg hover:bg-indigo-500/20 transition-colors ml-1"
                  title="Voice Mode"
                >
      ...
      {isActive && (
        <div className="w-[240px] border-l border-[#1a1a2e] flex flex-col bg-[#0a0a14] flex-shrink-0">
          <div className="px-4 py-3 border-b border-[#1a1a2e]">
            <h3 className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Session Dashboard</h3>
          </div>
